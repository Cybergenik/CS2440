...
<body id="bg">
  <?php
    ...
    if(isset($_GET['err'])){
      if ($_GET['err'] == 1){
        echo "<h4 style='font-color: red; text-align: center;'>Please fill Email field</h4>";
      }
      elseif ($_GET['err'] == 2){
        echo "<h4 style='font-color: red; text-align: center;'>Please fill Phone field</h4>";
      }
      elseif ($_GET['err'] == 3){
        echo "<h4 style='font-color: red; text-align: center;'>Please fill out Both fields</h4>";
      }
      elseif ($_GET['err'] == 4){
        echo "<h4 style='font-color: red; text-align: center;'>Invalid Email field</h4>";
      }
      elseif ($_GET['err'] == 5){
        echo "<h4 style='font-color: red; text-align: center;'>Invalid Phone field</h4>";
      }
      elseif ($_GET['err'] == 6){
        echo "<h4 style='font-color: red; text-align: center;'>Both Fields are Invalid</h4>";
      }
    }
